...
/*
 * OutputDocumentCommand is a class that captures the setShowGuide Command.
 */
...
public class OutputDocumentCommand implements Command {

    // Debug delta used to adjust the local logging level.
    private static final int DD = 0;

    private final String className = "OutputDocumentCommand";
    private final String originalValue;
    private String newValue;

    public OutputDocumentCommand(String value) {
        originalValue = Model.getInstance().getOutputDocument();
        newValue = value;
    }
    ...
    public boolean update(Command newCommand) {
        ...
        OutputDocumentCommand command = (OutputDocumentCommand)newCommand;
