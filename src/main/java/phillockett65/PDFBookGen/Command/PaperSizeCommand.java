...
/*
 * PaperSizeCommand is a class that captures the setShowGuide Command.
 */
...
public class PaperSizeCommand implements Command {

    // Debug delta used to adjust the local logging level.
    private static final int DD = 0;

    private final String className = "PaperSizeCommand";
    private final String originalValue;
    private String newValue;
 
    public PaperSizeCommand(String oldVal, String newVal) {
    ...
    @Override
    public void execute() {
        Model.getInstance().setPaperSize(newValue);
    }
    ...
    public void undo() {
        ...
        model.setPaperSize(originalValue);
        model.syncUI();
    }
    ...
    public boolean update(Command newCommand) {
        ...
        PaperSizeCommand command = (PaperSizeCommand)newCommand;
