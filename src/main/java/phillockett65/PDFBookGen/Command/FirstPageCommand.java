...
/*
 * FirstPageCommand is a class that captures the setShowGuide Command.
 */
...
public class FirstPageCommand implements Command {
    ...
    private final String className = "FirstPageCommand";
    private final int originalValue;
    private int newValue;
 
    public FirstPageCommand(int oldVal, int newVal) {
    ...
    private void worker(int value) {
        ...
        model.setFirstPage(value);
        model.getController().syncLastPageSpinner();
        model.syncUI();
    }
    ...
    public boolean update(Command newCommand) {
        ...
        FirstPageCommand command = (FirstPageCommand)newCommand;
